...
import email from "@/components/sections/ecommerce/checkoutForms/email.vue";
import customerName from "@/components/sections/ecommerce/checkoutForms/customerName.vue";
import addressTab from "@/components/sections/ecommerce/checkoutForms/address.vue";
import paymentTwo from "@/components/sections/ecommerce/checkoutForms/paymentTakeTwo.vue";
